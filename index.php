...
<html>
    ...
    <body>
        ...
        <section class="s-page-2">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 align="center">
                            <?=$lang['section_2_title']?>
                        </h2>
                    </div>
                    <div class="col-md-4">
                        <div class="box-home-2">
                            ...
                            <div class="box-txt">
                                <h3>
                                    <?=$lang['section_2_box_1_title']?>
                                </h3>
                                <p>
                                    <?=$lang['section_2_box_1_text']?>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="box-home-2">
                            ...
                            <div class="box-txt">
                                <h3>
                                    <?=$lang['section_2_box_2_title']?>
                                </h3>
                                <p>
                                    <?=$lang['section_2_box_2_text']?>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="box-home-2">
                            ...
                            <div class="box-txt">
                                <h3>
                                    <?=$lang['section_2_box_3_title']?>
                                </h3>
                                <p>
                                    <?=$lang['section_2_box_3_text']?>
                                </p>
                            </div>
                        </div>
                    </div>
